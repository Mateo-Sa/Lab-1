...
public class SmallFigure : Figure
{
    ...
    public override Figure Clone() { return new SmallFigure(); }
...
public class LargeFigure : Figure
{
    ...
    public override Figure Clone() { return new LargeFigure(); }
...
public class SuperFigure : Figure
{
    ...
    public override Figure Clone() { return new SuperFigure(); }
